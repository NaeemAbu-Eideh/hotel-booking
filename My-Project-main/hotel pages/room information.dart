...
class RoomInformationPage extends StatefulWidget {
  const RoomInformationPage({super.key});

  @override
  State<RoomInformationPage> createState() => _RoomInformationPageState();
}
            ...
            Row(
              children: [
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: ()async{
                      if(numberOfRooms.text == ""||roomNumber.text == "" || highClass == null || information.text == "" || price.text == ""){
                        DangerAlertBox(
                          context: context,
                          title: "Wrong",
                       ...
                       if(count == 0){index = int.parse(numberOfRooms.text);count++;}
                       if(index == 0){
                         DangerAlertBox(
                           context: context,
                           title: "Wrong",
                           messageText: "you have entered all the rooms, you can't enter any more"
                         );
                       }
                       else{
                         if(count == 0){index = int.parse(numberOfRooms.text);count++;}
                         bool check = false;
                         counter = Rooms.length+1;
                         ...
                         if(check == true){
                           ...
                           for(int i=0;i<images.length;i++){
                             await setRoomImage(images[i], hotelAccount['fname'], roomNumber.text);
                           }
                           images.clear();
                           //index--;
